...
#if 1
	if(!frgl_stricmp(t, "jpg") || !frgl_stricmp(t, "jpeg"))
	{
//		printf("load jpeg %s\n", name);
...
#if 0
	if(!frgl_stricmp(type, "jpg") || !frgl_stricmp(type, "jpeg"))
	{
//		printf("load jpeg %s\n", name);
