...
BTEIFGL_API void BGBDT_MsImaAdpcm_DecodeBlockMono(
...
BTEIFGL_API void BGBDT_MsImaAdpcm_DecodeBlockMonoAsStereo(
	byte *ibuf, s16 *obuf, int len)
{
	int pred, index, step, diff, uni, sni;
	int i, j;
...
BTEIFGL_API void BGBDT_MsImaAdpcm_EncodeBlockMono(
...
BTEIFGL_API void BGBDT_MsImaAdpcm_DecodeBlockStereo(
	byte *ibuf, s16 *obuf, int len)
{
...
BTEIFGL_API void BGBDT_MsImaAdpcm_EncodeBlockStereo(
...
BTEIFGL_API int BGBDT_SndBTAC1C_EncodeQuantUni(
...
BTEIFGL_API int BGBDT_SndBTAC1C_EncodeQuantUni3(
...
BTEIFGL_API void BGBDT_SndBTAC1C_EncodeBlockStereoJS(
	s16 *ibuf, byte *obuf, int len, int *ridx)
{
...
BTEIFGL_API void BGBDT_SndBTAC1C_DecodeBlockStereo(
	byte *ibuf, s16 *obuf, int len)
{
	int i;
...
BTEIFGL_API void BGBDT_SndBTAC1C_DecodeBlockMonoLg2(
	byte *ibuf, s16 *obuf, int lg2)
{
	int i, j, k, l;
...
BTEIFGL_API void BGBDT_SndBTAC1C_EncodeBlockStereoLg2(
	s16 *ibuf, byte *obuf, int lg2, int *ridx)
{
	s16 stbuf[2048];
	int len, len2;
