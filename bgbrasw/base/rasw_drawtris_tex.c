...
#define XY_SH_OFS	255
#define XY_SH_OFS1	127
...
//	mip=0;
	...
	if(!tergba)
	{
		if(prim->tex->cmptx[mip])
		{
			BGBRASW_CheckDecodeTexture(ctx, prim->tex, mip);
			tergba=prim->tex->rgba[mip];
		}
...
//	ye1=y1>>XY_SHR2;
//	ye2=y2>>XY_SHR2;
	ye1=(y1+XY_SH_OFS1)>>XY_SHR2;
	ye2=(y2+XY_SH_OFS)>>XY_SHR2;
...
#endif
//	j=(t0*t0+t1*t1)/(xs*xs+ys*ys+1);
	j=bgbrasw_fixdiv2_s32((t0*t0+t1*t1), (xs*xs+ys*ys+1));
//	mip=(bgbrasw_log2dn(j)+1)/2;
	k=bgbrasw_log2f8(j);
	mip=((k>>8)+1)/2;
	if(mip>15)mip=15;
...
//		xc0v=((x1-x0)<<XY_SHL)/ys;
//		xc1v=((x2-x0)<<XY_SHL)/ys1;
		xc0v=bgbrasw_fixdiv_s32_u16(((x1-x0)<<XY_SHL), ys);
		xc1v=bgbrasw_fixdiv_s32_u16(((x2-x0)<<XY_SHL), ys1);
...
//			sttbv=((st1t-st0t)<<ST_SHL)/ys;
			...
			stsav=bgbrasw_fixdiv_s32_u16(((st2s-st0s)<<ST_SHL), ys1);
			sttav=bgbrasw_fixdiv_s32_u16(((st2t-st0t)<<ST_SHL), ys1);
			stsbv=bgbrasw_fixdiv_s32_u16(((st1s-st0s)<<ST_SHL), ys);
			sttbv=bgbrasw_fixdiv_s32_u16(((st1t-st0t)<<ST_SHL), ys);

//			zsav=((s32)(z2-z0))/ys1;
//			zsbv=((s32)(z1-z0))/ys;

			zsav=bgbrasw_fixdiv_s32_u16(((s32)(z2-z0)), ys1);
			zsbv=bgbrasw_fixdiv_s32_u16(((s32)(z1-z0)), ys);
...
//			sttbv=((st2t-st0t)<<ST_SHL)/ys1;
			...
			stsav=bgbrasw_fixdiv_s32_u16(((st1s-st0s)<<ST_SHL), ys);
			sttav=bgbrasw_fixdiv_s32_u16(((st1t-st0t)<<ST_SHL), ys);
			stsbv=bgbrasw_fixdiv_s32_u16(((st2s-st0s)<<ST_SHL), ys1);
			sttbv=bgbrasw_fixdiv_s32_u16(((st2t-st0t)<<ST_SHL), ys1);

//			zsav=((s32)(z1-z0))/ys;
//			zsbv=((s32)(z2-z0))/ys1;

			zsav=bgbrasw_fixdiv_s32_u16(((s32)(z1-z0)), ys);
			zsbv=bgbrasw_fixdiv_s32_u16(((s32)(z2-z0)), ys1);
...
//		sttbv=((st2t-stt1)<<ST_SHL)/ys;
		...
		stsav=bgbrasw_fixdiv_s32_u16((st2s-sts0)<<ST_SHL, ys);
		sttav=bgbrasw_fixdiv_s32_u16((st2t-stt0)<<ST_SHL, ys);
		stsbv=bgbrasw_fixdiv_s32_u16((st2s-sts1)<<ST_SHL, ys);
		sttbv=bgbrasw_fixdiv_s32_u16((st2t-stt1)<<ST_SHL, ys);

//		zsav=((s32)(z2-zsa))/ys;
//		zsbv=((s32)(z2-zsb))/ys;

		zsav=bgbrasw_fixdiv_s32_u16((s32)(z2-zsa), ys);
		zsbv=bgbrasw_fixdiv_s32_u16((s32)(z2-zsb), ys);
