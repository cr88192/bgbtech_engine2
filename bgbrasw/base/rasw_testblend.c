...
//	tabs->doBlend=BGBRASW_DoBlend_Generic;
	...
	{
		tabs->drawSpanTextureBasic=
			BGBRASW_DrawSpanTextureBasicATest;
		tabs->drawSpanTextureInterp=
			BGBRASW_DrawSpanTextureInterpATest;
		tabs->drawSpanTextureBasic_mag=
			BGBRASW_DrawSpanTextureBasicATest;
		tabs->drawSpanTextureInterp_mag=
			BGBRASW_DrawSpanTextureInterpATest;
		...
		tabs->drawSpanTextureBasicZTest=
			BGBRASW_DrawSpanTextureBasicZATest;
		tabs->drawSpanTextureInterpZTest=
			BGBRASW_DrawSpanTextureInterpZATest;
		tabs->drawSpanTextureBasicZTest_mag=
			BGBRASW_DrawSpanTextureBasicZATest;
		tabs->drawSpanTextureInterpZTest_mag=
			BGBRASW_DrawSpanTextureInterpZATest;
...
//			tabs->drawSpanTex_min=BGBRASW_DrawSpanTextureInterpTestBlend;
		...
		case BGBRASW_GL_LINEAR_MIPMAP_LINEAR:
			...
			{
				tabs->drawSpanTextureBasicZTest_mag2=
					BGBRASW_DrawSpanTextureBasicZATestLinear;
				tabs->drawSpanTextureInterpZTest_mag2=
					BGBRASW_DrawSpanTextureInterpZATestLinear;
			}else
			{
				tabs->drawSpanTextureBasicZTest_mag2=
	...
	BGBRASW_TestBlendData *dsttabs)
{
	...
	dsttabs->query_id=srctabs->query_id;
