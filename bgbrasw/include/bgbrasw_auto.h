...
BGBRASW_API void BGBRASW_ClearQueryValue(BGBRASW_Context *ctx, int id);
BGBRASW_API int BGBRASW_GetQueryValue(BGBRASW_Context *ctx, int id);
...
void BGBRASW_DrawSpanTextureBasic(BGBRASW_TestBlendData *tabs, bgbrasw_pixel *span, int npix, int xo, int yo, bgbrasw_pixel *tex, int txs, int tys, int st0s, int st0t, int st1s, int st1t);
void BGBRASW_DrawSpanTextureInterp(BGBRASW_TestBlendData *tabs, bgbrasw_pixel *span, int npix, int xo, int yo, bgbrasw_pixel *tex, int txs, int tys, int st0s, int st0t, int st1s, int st1t, bgbrasw_pixel clr0, bgbrasw_pixel clr1);
void BGBRASW_DrawSpanTextureBasicATest(BGBRASW_TestBlendData *tabs, bgbrasw_pixel *span, int npix, int xo, int yo, bgbrasw_pixel *tex, int txs, int tys, int st0s, int st0t, int st1s, int st1t);
void BGBRASW_DrawSpanTextureInterpATest(BGBRASW_TestBlendData *tabs, bgbrasw_pixel *span, int npix, int xo, int yo, bgbrasw_pixel *tex, int txs, int tys, int st0s, int st0t, int st1s, int st1t, bgbrasw_pixel clr0, bgbrasw_pixel clr1);
void BGBRASW_DrawSpanTextureBasicZTest(BGBRASW_TestBlendData *tabs, bgbrasw_pixel *span, bgbrasw_zbuf *spanz, int npix, int xo, int yo, bgbrasw_pixel *tex, int txs, int tys, int st0s, int st0t, int st1s, int st1t, bgbrasw_zbuf z0, bgbrasw_zbuf z1);
void BGBRASW_DrawSpanTextureInterpZTest(BGBRASW_TestBlendData *tabs, bgbrasw_pixel *span, bgbrasw_zbuf *spanz, int npix, int xo, int yo, bgbrasw_pixel *tex, int txs, int tys, int st0s, int st0t, int st1s, int st1t, bgbrasw_pixel clr0, bgbrasw_pixel clr1, bgbrasw_zbuf z0, bgbrasw_zbuf z1);
void BGBRASW_DrawSpanTextureBasicLinear(BGBRASW_TestBlendData *tabs, bgbrasw_pixel *span, int npix, int xo, int yo, bgbrasw_pixel *tex, int txs, int tys, int st0s, int st0t, int st1s, int st1t);
void BGBRASW_DrawSpanTextureInterpLinear(BGBRASW_TestBlendData *tabs, bgbrasw_pixel *span, int npix, int xo, int yo, bgbrasw_pixel *tex, int txs, int tys, int st0s, int st0t, int st1s, int st1t, bgbrasw_pixel clr0, bgbrasw_pixel clr1);
void BGBRASW_DrawSpanTextureBasicZTestLinear(BGBRASW_TestBlendData *tabs, bgbrasw_pixel *span, bgbrasw_zbuf *spanz, int npix, int xo, int yo, bgbrasw_pixel *tex, int txs, int tys, int st0s, int st0t, int st1s, int st1t, bgbrasw_zbuf z0, bgbrasw_zbuf z1);
void BGBRASW_DrawSpanTextureInterpZTestLinear(BGBRASW_TestBlendData *tabs, bgbrasw_pixel *span, bgbrasw_zbuf *spanz, int npix, int xo, int yo, bgbrasw_pixel *tex, int txs, int tys, int st0s, int st0t, int st1s, int st1t, bgbrasw_pixel clr0, bgbrasw_pixel clr1, bgbrasw_zbuf z0, bgbrasw_zbuf z1);
void BGBRASW_DrawSpanTextureBasicZATest(BGBRASW_TestBlendData *tabs, bgbrasw_pixel *span, bgbrasw_zbuf *spanz, int npix, int xo, int yo, bgbrasw_pixel *tex, int txs, int tys, int st0s, int st0t, int st1s, int st1t, bgbrasw_zbuf z0, bgbrasw_zbuf z1);
void BGBRASW_DrawSpanTextureInterpZATest(BGBRASW_TestBlendData *tabs, bgbrasw_pixel *span, bgbrasw_zbuf *spanz, int npix, int xo, int yo, bgbrasw_pixel *tex, int txs, int tys, int st0s, int st0t, int st1s, int st1t, bgbrasw_pixel clr0, bgbrasw_pixel clr1, bgbrasw_zbuf z0, bgbrasw_zbuf z1);
void BGBRASW_DrawSpanTextureBasicZATestLinear(BGBRASW_TestBlendData *tabs, bgbrasw_pixel *span, bgbrasw_zbuf *spanz, int npix, int xo, int yo, bgbrasw_pixel *tex, int txs, int tys, int st0s, int st0t, int st1s, int st1t, bgbrasw_zbuf z0, bgbrasw_zbuf z1);
void BGBRASW_DrawSpanTextureInterpZATestLinear(BGBRASW_TestBlendData *tabs, bgbrasw_pixel *span, bgbrasw_zbuf *spanz, int npix, int xo, int yo, bgbrasw_pixel *tex, int txs, int tys, int st0s, int st0t, int st1s, int st1t, bgbrasw_pixel clr0, bgbrasw_pixel clr1, bgbrasw_zbuf z0, bgbrasw_zbuf z1);
...
void BGBRASW_DrawSpanFlatBasic(BGBRASW_TestBlendData *tabs, bgbrasw_pixel *span, int npix, int xo, int yo, bgbrasw_pixel clr);
void BGBRASW_DrawSpanFlatInterp(BGBRASW_TestBlendData *tabs, bgbrasw_pixel *span, int npix, int xo, int yo, bgbrasw_pixel clr0, bgbrasw_pixel clr1);
void BGBRASW_DrawSpanFlatBasicZTest(BGBRASW_TestBlendData *tabs, bgbrasw_pixel *span, bgbrasw_zbuf *spanz, int npix, int xo, int yo, bgbrasw_pixel clr, bgbrasw_zbuf z0, bgbrasw_zbuf z1);
void BGBRASW_DrawSpanFlatInterpZTest(BGBRASW_TestBlendData *tabs, bgbrasw_pixel *span, bgbrasw_zbuf *spanz, int npix, int xo, int yo, bgbrasw_pixel clr0, bgbrasw_pixel clr1, bgbrasw_zbuf z0, bgbrasw_zbuf z1);
//AHSRC:base/rasw_drsp_tblend.c
void BGBRASW_DrawSpanFlatBasicTestBlend(BGBRASW_TestBlendData *testData, bgbrasw_pixel *span, bgbrasw_zbuf *spanz, int npix, int xo, int yo, bgbrasw_pixel clr, bgbrasw_zbuf z0, bgbrasw_zbuf z1);
void BGBRASW_DrawSpanFlatInterpTestBlend(BGBRASW_TestBlendData *testData, bgbrasw_pixel *span, bgbrasw_zbuf *spanz, int npix, int xo, int yo, bgbrasw_pixel clr0, bgbrasw_pixel clr1, bgbrasw_zbuf z0, bgbrasw_zbuf z1);
void BGBRASW_DrawSpanTextureBasicTestBlend(BGBRASW_TestBlendData *testData, bgbrasw_pixel *span, bgbrasw_zbuf *spanz, int npix, int xo, int yo, bgbrasw_pixel *tex, int txs, int tys, int st0s, int st0t, int st1s, int st1t, bgbrasw_zbuf z0, bgbrasw_zbuf z1);
void BGBRASW_DrawSpanTextureInterpTestBlend(BGBRASW_TestBlendData *testData, bgbrasw_pixel *span, bgbrasw_zbuf *spanz, int npix, int xo, int yo, bgbrasw_pixel *tex, int txs, int tys, int st0s, int st0t, int st1s, int st1t, bgbrasw_pixel clr0, bgbrasw_pixel clr1, bgbrasw_zbuf z0, bgbrasw_zbuf z1);
...
void BGBRASW_DrawSpanTextureLinearInterpTestBlend(BGBRASW_TestBlendData *testData, bgbrasw_pixel *span, bgbrasw_zbuf *spanz, int npix, int xo, int yo, bgbrasw_pixel *tex, int txs, int tys, int st0s, int st0t, int st1s, int st1t, bgbrasw_pixel clr0, bgbrasw_pixel clr1, bgbrasw_zbuf z0, bgbrasw_zbuf z1);
...
BGBRASW_API void BGBRASW_SetCompressedTexturePixelsSize(BGBRASW_Context *ctx, BGBRASW_Texture *tex, bgbrasw_pixel *pix, int xs, int ys, int lvl, int fmt);
BGBRASW_API void BGBRASW_SetCompressedTextureSizeMip(BGBRASW_Context *ctx, BGBRASW_Texture *tex, int xs, int ys, int lvl, int fmt);
...
void BGBRASW_DecodeImage(byte *ibuf, bgbrasw_pixel *obuf,int xs, int ys, int bsz, int fmt);
BGBRASW_API void BGBRASW_CheckDecodeTexture(BGBRASW_Context *ctx, BGBRASW_Texture *tex, int mip);
...
//AHSRC:base/rasw_bc7_bitstream.c
