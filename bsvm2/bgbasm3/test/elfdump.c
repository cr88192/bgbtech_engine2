...
int elf32_addr(Elf32_Addr val)
{
	return(val.a|(val.b<<8)|(val.c<<16)|(val.d<<24));
}

int elf32_off(Elf32_Off val)
{
	return(val.a|(val.b<<8)|(val.c<<16)|(val.d<<24));
}

int elf32_sword(Elf32_Sword val)
{
	return(val.a|(val.b<<8)|(val.c<<16)|(val.d<<24));
}

int elf32_word(Elf32_Word val)
{
	return(val.a|(val.b<<8)|(val.c<<16)|(val.d<<24));
}

int elf32_half(Elf32_Half val)
{
	return(val.a|(val.b<<8));
}


void elf32_dump_ehdr(Elf32_Ehdr *hdr)
{
...
void elf32_dump_shdr(Elf32_Shdr *hdr, char *strtab)
{
	char *s;
	int i;
...
char *elf32_get_section_name(Elf32_Context *ctx, int num)
{
	Elf32_Shdr *shdr;
	char *s;
	int i;
...
int elf32_lookup_section(Elf32_Context *ctx, char *name)
{
	Elf32_Shdr *shdr;
	char *s;
	int i, j;
...
int elf32_dump_symbol(Elf32_Context *ctx, int num)
{
	Elf32_Sym *sym;
	char *s;
	int i;
...
char *elf32_get_symbol_name(Elf32_Context *ctx, int num)
{
	Elf32_Sym *sym;
	char *s;
	int i;
...
int elf32_lookup_symbol(Elf32_Context *ctx, char *name)
{
	Elf32_Sym *sym;
	char *s;
	int i, j;
