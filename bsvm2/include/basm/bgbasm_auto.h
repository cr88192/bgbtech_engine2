//AHSRC:bsvm2.l/bgbasm3/front/basm_api.c
...
//AHSRC:bsvm2.l/bgbasm3/front/basm_rand.c
int basm_genseed();
void BASM_InitRand();
u32 basm_rand();
char *basm_rand_key12();
char *basm_rand_key18();
//AHSRC:bsvm2.l/bgbasm3/front/basm_callsig.c
...
void BASM_InitSig();
BASM_API void *BASM_MakeBufferCallStub(void *fcn, char *sig);
//AHSRC:bsvm2.l/bgbasm3/front/basm_vfs.c
...
//AHSRC:bsvm2.l/bgbasm3/front/basm_preproc.c
void *basm_loadfile(char *name, int *rsz);
...
//AHSRC:bsvm2.l/bgbasm3/asm/basm_core.c
...
//AHSRC:bsvm2.l/bgbasm3/asm/basm_parse.c
...
//AHSRC:bsvm2.l/bgbasm3/asm/basm_insns_x86.c
//AHSRC:bsvm2.l/bgbasm3/asm/basm_insns_arm.c
//AHSRC:bsvm2.l/bgbasm3/asm/basm_insns_thumb.c
//AHSRC:bsvm2.l/bgbasm3/asm/basm_disasm.c
BASM_API char *BASM_GetPtrName(void *ptr);
...
//AHSRC:bsvm2.l/bgbasm3/asm/basm_coff.c
...
//AHSRC:bsvm2.l/bgbasm3/link/link_context.c
...
//AHSRC:bsvm2.l/bgbasm3/link/link_core.c
...
//AHSRC:bsvm2.l/bgbasm3/link/link_thunk.c
...
//AHSRC:bsvm2.l/bgbasm3/link/link_lnx.c
int BLNK_InitDllsOS();
...
//AHSRC:bsvm2.l/bgbasm3/link/link_w32.c
BASM_API int BLNK_GetModuleListOS(char **buf, int max);
BASM_API char **BLNK_GetEnvironOS();
...
int BLNK_ProcessEXE(char *name);
//AHSRC:bsvm2.l/bgbasm3/link/link_vfs.c
...
//AHSRC:bsvm2.l/bgbasm3/link/bldr_coff.c
...
//AHSRC:bsvm2.l/bgbasm3/link/bldr_elf.c
