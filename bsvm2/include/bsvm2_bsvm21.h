...
#define BSVM2_OPRU_NEG		0
#define BSVM2_OPRU_NOT		1
...
#define BSVM2_OP_ANDISLC	0x01C3	//
#define BSVM2_OP_ORISLC		0x01C4	//
#define BSVM2_OP_XORISLC	0x01C5	//
#define BSVM2_OP_SHLISLC	0x01C6	//
#define BSVM2_OP_SARISLC	0x01C7	//
#define BSVM2_OP_ADDISLL	0x01C8	//
#define BSVM2_OP_SUBISLL	0x01C9	//
#define BSVM2_OP_MULISLL	0x01CA	//
#define BSVM2_OP_ANDISLL	0x01CB	//
#define BSVM2_OP_ORISLL		0x01CC	//
#define BSVM2_OP_XORISLL	0x01CD	//
#define BSVM2_OP_SHLISLL	0x01CE	//
#define BSVM2_OP_SARISLL	0x01CF	//
#define BSVM2_OP_ADDILSC	0x01D0	//
#define BSVM2_OP_SUBILSC	0x01D1	//
#define BSVM2_OP_MULILSC	0x01D2	//
#define BSVM2_OP_ANDILSC	0x01D3	//
#define BSVM2_OP_ORILSC		0x01D4	//
#define BSVM2_OP_XORILSC	0x01D5	//
#define BSVM2_OP_SHLILSC	0x01D6	//
#define BSVM2_OP_SARILSC	0x01D7	//
#define BSVM2_OP_ADDILSL	0x01D8	//
#define BSVM2_OP_SUBILSL	0x01D9	//
#define BSVM2_OP_MULILSL	0x01DA	//
#define BSVM2_OP_ANDILSL	0x01DB	//
#define BSVM2_OP_ORILSL		0x01DC	//
...
#define BSVM2_OP_CMPXL		0x0438	//Compare Int128
#define BSVM2_OP_UCMPXL		0x0439	//Unsigned Compare Int128
#define BSVM2_OP_CMPXF		0x043A	//Compare Float128
#define BSVM2_OP_CMP2XF		0x043B	//Unordered Compare Float128
...
#define BSVM2_OP_LDIXX		0x0450	//
#define BSVM2_OP_STIXX		0x0451	//
...
short ntrace;		//number of traces
short stkpos;		//stack pos (decoding)

short bargs;		//number of local variables
short stkdepth;		//size of temporaries stack
short ngi;			//number of global indices
