...
#if defined(_M_IX86) && !defined(X86_MSVC)
#define X86_MSVC
#endif
#if defined(_M_X64) && !defined(X64_MSVC)
#define X64_MSVC
#endif
#if defined(_M_ARM) && !defined(ARM_MSVC)
#define ARM_MSVC
#endif
...
#ifdef WIN32
#ifdef BS2VM_DLL
#define BS2VM_API __declspec(dllexport)
#else
#define BS2VM_API __declspec(dllimport)
#endif
#else
#define BS2VM_API
#endif
