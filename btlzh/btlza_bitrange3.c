...
int BTLZA_BitArith3_InputByte(BGBBTJ_BTLZA_Context *ctx)
{
//	if(ctx->cs>ctx->cse)
//		return(0);
	return(*ctx->cs++);
...
void BTLZA_BitArith3_OutputByte(BGBBTJ_BTLZA_Context *ctx, int i)
{
//	if(ctx->ct>ctx->cte)
//		return;
	*ctx->ct++=i;
...
void BTLZA_BitArith3_NormalizeOutput(BGBBTJ_BTLZA_Context *ctx)
{
...
void BTLZA_BitArith3_NormalizeInput(BGBBTJ_BTLZA_Context *ctx)
{
	while(!((ctx->rmin^ctx->rmax)>>24))
	{
		ctx->rmin<<=8;
...
void BTLZA_BitArith3_FlushWBits(BGBBTJ_BTLZA_Context *ctx)
{
...
void BTLZA_BitArith3_OutputFixedBit(BGBBTJ_BTLZA_Context *ctx, int i)
{
	u32 r, r2, v;
	int j;
...
int BTLZA_BitArith3_InputFixedBit(BGBBTJ_BTLZA_Context *ctx)
{
	u32 r, r2, v, i;
...
void BTLZA_BitArith3_OutputBit(BGBBTJ_BTLZA_Context *ctx,
	int i, u32 w)
{
	u32 r, r2, v;
	int j;
...
int BTLZA_BitArith3_InputBit(BGBBTJ_BTLZA_Context *ctx, u32 w)
{
	u32 r, r2, v, i;
...
void BTLZA_BitArith3_OutputModelBit(BGBBTJ_BTLZA_Context *ctx,
	int i, byte *mctx)
{
	u32 r, v, w, s;
	int j;
...
int BTLZA_BitArith3_InputModelBit(BGBBTJ_BTLZA_Context *ctx, byte *mctx)
{
	u32 r, v, w, s;
	int i, j, k;
...
void BTLZA_BitArith3_OutputFixedBits(BGBBTJ_BTLZA_Context *ctx,
	int v, int n)
{
	int i, j, k, l;
...
int BTLZA_BitArith3_InputFixedBits(BGBBTJ_BTLZA_Context *ctx, int n)
{
	int i, j, k, l;
...
int BTLZA_BitArith3_InputContextFixedBits(BGBBTJ_BTLZA_Context *ctx, int n)
{
	int i, j, k, l;
...
int BTLZA_BitArith3_InputContextFixedBitsLE(BGBBTJ_BTLZA_Context *ctx, int n)
{
	int i, j, k, l;
...
void BTLZA_BitArith3_OutputContextModelBits(BGBBTJ_BTLZA_Context *ctx,
	int v, int n, byte *mdl, int ctxmask)
{
	...
	{
		l=(v>>i)&1;
		BTLZA_BitArith3_OutputModelBit(ctx, l, mdl+btlza_ctxindex(j, k));
		j=(j<<1)|l;
	}
	ctx->wctx=j;
}

int BTLZA_BitArith3_InputContextModelBits(BGBBTJ_BTLZA_Context *ctx,
	int n, byte *mdl, int ctxmask)
{
	...
	while(i--)
	{
		l=BTLZA_BitArith3_InputModelBit(ctx, mdl+btlza_ctxindex(j, k));
		j=(j<<1)|l;
	}
	ctx->wctx=j;
	return(j&((1<<n)-1));
...
void BTLZA_BitArith3_OutputExtraBits(BGBBTJ_BTLZA_Context *ctx,
	int v, int n, byte *mdl, int ctxmask)
{
	switch(n)
	{
...
void BTLZA_BitArith3_OutputContextModelBitsLE(BGBBTJ_BTLZA_Context *ctx,
	int v, int n, byte *mdl, int ctxmask)
{
	int i, j, k, l;
...
int BTLZA_BitArith3_InputContextModelBitsLE(BGBBTJ_BTLZA_Context *ctx,
	int n, byte *mdl, int ctxmask)
{
	int i, j, k, l;
	int v;
...
int BTLZA_BitArith3_InputExtraBits(BGBBTJ_BTLZA_Context *ctx,
	int n, byte *mdl, int ctxmask)
{
	int i, j;
	int v;
...
int BTLZA_BitArith3_SetupEncode(BGBBTJ_BTLZA_Context *ctx, byte *out, int sz)
{
	ctx->ct=out;
	ctx->cte=out+sz;
...
int BTLZA_BitArith3_SetupDecode(BGBBTJ_BTLZA_Context *ctx, byte *in, int sz)
{
	int i;
...
int BTLZA_BitArith3_SetupBeginEncode(BGBBTJ_BTLZA_Context *ctx)
{
	ctx->rmin=BTLZA_BITARITH_LOWER;
	ctx->rmax=BTLZA_BITARITH_UPPER;
	return(0);
...
int BTLZA_BitArith3_SetupBeginDecode(BGBBTJ_BTLZA_Context *ctx)
{
	int i;
...
int BTLZA_BitArith3_SetupEndDecode(BGBBTJ_BTLZA_Context *ctx)
{
	ctx->rmin=0;
	ctx->rmax=0;
	return(0);
...
void BTLZA_BitArith3_EncodeSymbolN(BGBBTJ_BTLZA_Context *ctx, int v, int n,
...
void BTLZA_BitArith3_EncodeSymbol6(BGBBTJ_BTLZA_Context *ctx, int v,
	byte *mdl, int ctxmask)
		{ BTLZA_BitArith3_EncodeSymbolN(ctx, v, 6, mdl, ctxmask); }
void BTLZA_BitArith3_EncodeSymbol8(BGBBTJ_BTLZA_Context *ctx, int v,
	byte *mdl, int ctxmask)
		{ BTLZA_BitArith3_EncodeSymbolN(ctx, v, 8, mdl, ctxmask); }
void BTLZA_BitArith3_EncodeSymbol9(BGBBTJ_BTLZA_Context *ctx, int v,
	byte *mdl, int ctxmask)
		{ BTLZA_BitArith3_EncodeSymbolN(ctx, v, 9, mdl, ctxmask); }

void BTLZA_BitArith3_EncodeSymbol8LE(BGBBTJ_BTLZA_Context *ctx, int v,
	byte *mdl, int ctxmask)
{
	BTLZA_BitArith3_EncodeSymbolNLE(ctx, v, 8, mdl, ctxmask);
}

void BTLZA_BitArith3_EncodeSymbolNLE(BGBBTJ_BTLZA_Context *ctx,
	int v, int n, byte *mdl, int ctxmask)
{
	int i, j, k, l;
...
int BTLZA_BitArith3_DecodeSymbol6(BGBBTJ_BTLZA_Context *ctx,
	byte *mdl, int ctxmask)
{
	int i, j, k, v;

	j=ctx->wctx; k=ctxmask;
	i=BTLZA_BitArith3_InputModelBit(ctx, mdl+btlza_ctxindex(j, k)); j=(j<<1)|i;
	i=BTLZA_BitArith3_InputModelBit(ctx, mdl+btlza_ctxindex(j, k)); j=(j<<1)|i;
	i=BTLZA_BitArith3_InputModelBit(ctx, mdl+btlza_ctxindex(j, k)); j=(j<<1)|i;
	i=BTLZA_BitArith3_InputModelBit(ctx, mdl+btlza_ctxindex(j, k)); j=(j<<1)|i;
	i=BTLZA_BitArith3_InputModelBit(ctx, mdl+btlza_ctxindex(j, k)); j=(j<<1)|i;
...
int BTLZA_BitArith3_DecodeSymbol8(BGBBTJ_BTLZA_Context *ctx,
	byte *mdl, int ctxmask)
{
	int i, j, k, v;
...
int BTLZA_BitArith3_DecodeSymbol9(BGBBTJ_BTLZA_Context *ctx,
	byte *mdl, int ctxmask)
{
	int i, j, k, v;
...
int BTLZA_BitArith3_DecodeSymbol8LE(BGBBTJ_BTLZA_Context *ctx,
	byte *mdl, int ctxmask)
{
	int i, j, k, v;
	...
	BGBBTJ_BTLZA_Context *ctx, int bits)
{
	...
	j=1<<bits;
	if(!ctx->mdl_lit)
		{ ctx->mdl_lit=gcalloc(j*sizeof(byte)); }
	ctx->ctxbits=bits;
	...
	j=1<<12;
	if(!ctx->mdl_dist)
		{ ctx->mdl_dist=gcalloc(j*sizeof(byte)); }
	if(!ctx->mdl_xbits)
		{ ctx->mdl_xbits=gcalloc(j*sizeof(byte)); }
	...
	BGBBTJ_BTLZA_Context *ctx, int bits)
{
	...
	j=1<<bits;
	if(!ctx->mdl_rbits)
		{ ctx->mdl_rbits=gcalloc(j*sizeof(byte)); }
...
BGBBTJ_API int BTLZA_BitArith3_EncodeDataCtx(
	BGBBTJ_BTLZA_Context *ctx,
...
BGBBTJ_API int BTLZA_BitArith3_DecodeDataCtx(
	BGBBTJ_BTLZA_Context *ctx,
...
BGBBTJ_API int BTLZA_BitArith3_EncodeData(
	byte *ibuf, int isz, byte *obuf, int osz)
{
	BGBBTJ_BTLZA_Context *ctx;
	int i, j;
...
BGBBTJ_API int BTLZA_BitArith3_DecodeData(
	byte *ibuf, int isz, byte *obuf, int osz)
{
	BGBBTJ_BTLZA_Context *ctx;
	int i, j;
...
BGBBTJ_API int BTLZA_BitArith3_EncodeTestData(
	byte *ibuf, int isz, byte *obuf, int osz)
{
	BGBBTJ_BTLZA_Context *ctx;
	byte *tbuf;
