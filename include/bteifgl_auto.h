...
//AHSRC:base/frgl_readavi.c
FRGL_VidCodec *FRGL_VidCodec_New();
FRGL_VidCodecCTX *FRGL_VidCodecCTX_New();
void FRGL_VidCodecCTX_Destroy(FRGL_VidCodecCTX *ctx);
int FRGL_Codec_DecompressQuery(int fcc,FRGL_BITMAPINFOHEADER *in, FRGL_BITMAPINFOHEADER *out);
int FRGL_Codec_CompressQuery(int fcc,FRGL_BITMAPINFOHEADER *in, FRGL_BITMAPINFOHEADER *out);
FRGL_VidCodecCTX *FRGL_Codec_BeginDecompress(int fcc,FRGL_BITMAPINFOHEADER *in, FRGL_BITMAPINFOHEADER *out);
FRGL_VidCodecCTX *FRGL_Codec_BeginCompress(int fcc,FRGL_BITMAPINFOHEADER *in, FRGL_BITMAPINFOHEADER *out);
int FRGL_Codec_DecompressFrame(FRGL_VidCodecCTX *ctx,void *src, void *dst, int ssz, int dsz);
int FRGL_Codec_DecompressFrameClrs(FRGL_VidCodecCTX *ctx,void *src, void *dst, int ssz, int dsz, int clrs);
int FRGL_Codec_DecompressFrame2(FRGL_VidCodecCTX *ctx,void *src, void *dst, int ssz, int dsz, int clrs);
int FRGL_Codec_CompressFrame(FRGL_VidCodecCTX *ctx,void *src, void *dst, int dsz, int qfl, int clrs, int *rfl);
...
int FRGL_AVI_GetMonoSamplesNoRate(FRGL_AVI_Context *ctx,short *samples, int cnt);
int FRGL_AVI_GetMonoSamplesRate(FRGL_AVI_Context *ctx,short *samples, int cnt, int rate);
...
int FRGL_AVI_DecodeVideo(FRGL_AVI_Context *ctx,int ofs, int skip, int clrs);
void *FRGL_AVI_DecodeFrame2(FRGL_AVI_Context *ctx, int skip, int clrs);
...
BTEIFGL_API BGBDT_VoxRegionBox *BGBDT_WorldGetRegionBox(BGBDT_VoxWorld *world,BGBDT_VoxCoord xyz, int accfl);
BTEIFGL_API BGBDT_VoxRegionBox *BGBDT_WorldGetRegionBoxBxyz(BGBDT_VoxWorld *world, int bx, int by, int bz, int accfl);
int BGBDT_WorldCheckRegionBoxMagic(byte *buf);
int BGBDT_WorldDecodeRegionBoxData(BGBDT_VoxWorld *world,BGBDT_VoxRegionBox *rgn);
...
int BGBDT_WorldSaveRegionBoxData(BGBDT_VoxWorld *world,BGBDT_VoxRegionBox *rgn);
void BGBDT_TickVoxRegionBox(BGBDT_VoxWorld *world,BGBDT_VoxRegionBox *rgn);
int BGBDT_RgnBox_UpdateChunkMap(BGBDT_VoxWorld *world, BGBDT_VoxChunk *chk);
...
BTEIFGL_API u32 BGBDT_WorldVoxel_GetVoxColorID(BGBDT_VoxWorld *world,BGBDT_VoxCoord xyz, BGBDT_VoxData td);
...
void BTIC1H_Range_OutputBit(BTIC1H_Context *ctx,int i, u32 w);
void BTIC1H_Range_OutputModelBit(BTIC1H_Context *ctx,int i, byte *mctx);
void BTIC1H_Range_OutputModelBit(BTIC1H_Context *ctx,int i, byte *mctx);
void BTIC1H_Range_OutputFixedBits(BTIC1H_Context *ctx,int v, int n);
void BTIC1H_Range_OutputContextModelBits(BTIC1H_Context *ctx,int v, int n, byte *mdl, int ctxmask);
void BTIC1H_Range_OutputContextModelBitsN4(BTIC1H_Context *ctx,int v, int n, byte *mdl, int ctxmask);
int BTIC1H_Range_SetupEncode(BTIC1H_Context *ctx, byte *out, int sz);
int BTIC1H_Range_SetupBeginEncode(BTIC1H_Context *ctx);
void BTIC1H_Range_EncodeSymbol8(BTIC1H_Context *ctx, int v,byte *mdl, int ctxmask);
void BTIC1H_Range_ResetContextWeights(BTIC1H_Context *ctx);
void BTIC1H_Range_SetupContextBits(BTIC1H_Context *ctx, int bits);
//AHSRC:fastbcn/bt1h_blkdec.c
void BTIC1H_DecodeBlockMB2B_Alpha(BTIC1H_Context *ctx, byte *block, byte *rgba, int xstride, int ystride, int tflip);
void BTIC1H_DecodeBlock_TransColor1YCbCr(BTIC1H_Context *ctx,int cy, int cu, int cv, int *rcr, int *rcg, int *rcb);
void BTIC1H_DecodeBlock_TransColor1ABYCbCr(BTIC1H_Context *ctx,int cya, int cua, int cva, int *rcra, int *rcga, int *rcba, int cyb, int cub, int cvb, int *rcrb, int *rcgb, int *rcbb);
void BTIC1H_DecodeBlock_TransColor2YCbCr(BTIC1H_Context *ctx,int cy0, int cy1, int cu, int cv, int *rcr0, int *rcg0, int *rcb0, int *rcr1, int *rcg1, int *rcb1);
void BTIC1H_DecodeBlock_TransColor420YCbCr(BTIC1H_Context *ctx,int cy0, int cy1, int cy2, int cy3, int cu, int cv, int *rcr0, int *rcg0, int *rcb0, int *rcr1, int *rcg1, int *rcb1, int *rcr2, int *rcg2, int *rcb2, int *rcr3, int *rcg3, int *rcb3);
void BTIC1H_DecodeBlock_TransColor1GDbDr(BTIC1H_Context *ctx,int cy, int cu, int cv, int *rcr, int *rcg, int *rcb);
void BTIC1H_DecodeBlock_TransColor1ABGDbDr(BTIC1H_Context *ctx,int cya, int cua, int cva, int *rcra, int *rcga, int *rcba, int cyb, int cub, int cvb, int *rcrb, int *rcgb, int *rcbb);
void BTIC1H_DecodeBlock_TransColor2GDbDr(BTIC1H_Context *ctx,int cy0, int cy1, int cu, int cv, int *rcr0, int *rcg0, int *rcb0, int *rcr1, int *rcg1, int *rcb1);
void BTIC1H_DecodeBlock_TransColor420GDbDr(BTIC1H_Context *ctx,int cy0, int cy1, int cy2, int cy3, int cu, int cv, int *rcr0, int *rcg0, int *rcb0, int *rcr1, int *rcg1, int *rcb1, int *rcr2, int *rcg2, int *rcb2, int *rcr3, int *rcg3, int *rcb3);
void BTIC1H_DecodeBlock_TransColor1(BTIC1H_Context *ctx,int cy, int cu, int cv, int *rcr, int *rcg, int *rcb);
void BTIC1H_DecodeBlock_TransColor1AB(BTIC1H_Context *ctx,int cya, int cua, int cva, int *rcra, int *rcga, int *rcba, int cyb, int cub, int cvb, int *rcrb, int *rcgb, int *rcbb);
void BTIC1H_DecodeBlock_TransColor2(BTIC1H_Context *ctx,int cy0, int cy1, int cu, int cv, int *rcr0, int *rcg0, int *rcb0, int *rcr1, int *rcg1, int *rcb1);
void BTIC1H_DecodeBlock_TransColor420(BTIC1H_Context *ctx,int cy0, int cy1, int cy2, int cy3, int cu, int cv, int *rcr0, int *rcg0, int *rcb0, int *rcr1, int *rcg1, int *rcb1, int *rcr2, int *rcg2, int *rcb2, int *rcr3, int *rcg3, int *rcb3);
void BTIC1H_DecodeBlockMB2B_PYUV_RGBI(BTIC1H_Context *ctx, byte *block, byte *rgba, int xstride, int ystride, int tflip);
void BTIC1H_DecodeBlockMB2B_P420_RGBI(BTIC1H_Context *ctx, byte *block, byte *rgba, int xstride, int ystride, int tflip);
void BTIC1H_DecodeBlockMB2B_I4XX_RGBI(BTIC1H_Context *ctx, byte *block, byte *rgba, int xstride, int ystride, int tflip);
void BTIC1H_DecodeBlockMB2B_RGBI(BTIC1H_Context *ctx, byte *block, byte *rgba, int xstride, int ystride, int tflip);
void BTIC1H_DecodeBlockMB2B_RGB(BTIC1H_Context *ctx, byte *block, byte *rgba, int xstride, int ystride);
void BTIC1H_DecodeBlockMB2B_BGR(BTIC1H_Context *ctx, byte *block, byte *rgba, int xstride, int ystride);
void BTIC1H_DecodeBlockMB2B_EdgeRGBI(BTIC1H_Context *ctx, byte *block, byte *rgba, int xstride, int ystride, int xfrac, int yfrac, int tflip);
void BTIC1H_DecodeBlockMB2B_PYUV_YUY(BTIC1H_Context *ctx, byte *block, byte *rgba, int xstride, int ystride, int tflip);
void BTIC1H_DecodeBlockMB2B_P420_YUV(BTIC1H_Context *ctx, byte *block, byte *rgba, int xstride, int ystride, int tflip);
void BTIC1H_DecodeBlockMB2B_I4XX_YUY(BTIC1H_Context *ctx, byte *block, byte *rgba, int xstride, int ystride, int tflip);
void BTIC1H_DecodeBlockMB2B_YUY(BTIC1H_Context *ctx, byte *block, byte *rgba, int xstride, int ystride, int tflip);
void BTIC1H_DecodeImageMB2B(BTIC1H_Context *ctx, byte *block, int blkstride, byte *rgba, int xs, int ys, int stride);
void BTIC1H_DecodeImageMB2B_ClrsBfl(BTIC1H_Context *ctx, byte *block, byte *blockfl, int blkstride, byte *rgba, int xs, int ys, int clrs);
void BTIC1H_DecodeImageMB2B_Clrs(BTIC1H_Context *ctx, byte *block, int blkstride, byte *rgba, int xs, int ys, int clrs);
//AHSRC:fastbcn/bt1h_common.c
...
int BTIC1H_DecodeCtx(BTIC1H_Context *ctx,byte *src, byte *dst, int ssz, int dsz, int *rxy, int *rys, int clrsfl);
//AHSRC:fastbcn/bt1h_decrice.c
...
int BTIC1H_Range_InputContextModelBits(BTIC1H_Context *ctx,int n, byte *mdl, int ctxmask);
int BTIC1H_Range_InputContextModelBitsN4(BTIC1H_Context *ctx,int n, byte *mdl, int ctxmask);
...
int BTIC1H_Range_DecodeSymbol8(BTIC1H_Context *ctx,byte *mdl, int ctxmask);
int BTIC1H_Range_DecodeSymbol1(BTIC1H_Context *ctx, byte *mdl, int ctxmask);
...
void BGBBTJ_BC7_EncodeBlock_VecSwapA(int *clra, int *clrb);
void BGBBTJ_BC7_EncodeBlock_VecInvertPixels(byte *pxv, int n, int min, int max);
void BTIC1H_BC7_EncodeBlock_Mode5(byte *block,byte *pxy, byte *pxa, int *min, int *max, int mcy, int ncy, int mca, int nca);
void BTIC1H_BC7_EncodeBlockBits48_Mode5(byte *block,u64 pxy, u64 pxa, int *min, int *max);
void BTIC1H_BC7_EncodeBlockBits32_Mode5(byte *block,u32 pxy, u32 pxa, int *min, int *max);
void BTIC1H_DecodeBlockMB2B_RGBI(BTIC1H_Context *ctx, byte *block, byte *rgba, int xstride, int ystride, int tflip);
void BTIC1H_ConvBlockSpecialBC7(BTIC1H_Context *ctx, byte *iblock, byte *oblock, int tfl);
void BTIC1H_ConvBlockBC7(BTIC1H_Context *ctx, byte *iblock, byte *oblock, int flip);
void BTIC1H_ConvImageBC7_I(BTIC1H_Context *ctx, byte *iblock, int iblkstr, byte *oblock, int oblkstr, int xs, int ys);
void BTIC1H_ConvImageBC7n(BTIC1H_Context *ctx, byte *iblock, int iblkstr, byte *oblock, int bcn, int xs, int ys);
void BGBBTJ_BitsLE_SetupRead(BGBBTJ_BitStream *ctx, byte *cs, int sz);
void BGBBTJ_BitsLE_ClearSetupRead(BGBBTJ_BitStream *ctx, byte *ct, int sz);
int BGBBTJ_BitsLE_ReadBits(BGBBTJ_BitStream *ctx, int n);
int BGBBTJ_BitsLE_ReadBit(BGBBTJ_BitStream *ctx);
...
int BGBBTJ_BC7_DecodeBlock_ReadMode(BGBBTJ_BitStream *bits);
void BGBBTJ_BC7_DecodeBlock(byte *block,byte *rgba, int xstride, int ystride, int flags);
void BTIC1H_BC7_DecodeImage(byte *block,byte *rgba, int xs, int ys, int stride, int pfb);
//AHSRC:fastbcn/bt1h_shim_s2tc.c
void BTIC1H_ConvBlockS2TC_Init();
void BTIC1H_S2TC_DecodeBlockRGBA(byte *block,byte *rgba, int xstride, int ystride, int pfb);
void BTIC1H_S2TC_DecodeImage(byte *block, int blkstride,byte *rgba, int xs, int ys, int stride, int pfb);
void BTIC1H_ConvBlockAlphaS2TC(BTIC1H_Context *ctx, byte *iblock, byte *oblock, int flip);
void BTIC1H_S2TC_EncodeBlockI(byte *block,byte *pxy, int *min, int *max, int mcy, int ncy);
void BTIC1H_DecodeBlockMB2B_RGBI(BTIC1H_Context *ctx, byte *block, byte *rgba, int xstride, int ystride, int tflip);
void BTIC1H_ConvBlockSpecialS2TC(BTIC1H_Context *ctx, byte *iblock, byte *oblock, int tfl);
void BTIC1H_ConvBlockS2TC(BTIC1H_Context *ctx, byte *iblock, byte *oblock, int flip);
void BTIC1H_ConvImageS2TC_I(BTIC1H_Context *ctx, byte *iblock, int iblkstr, byte *oblock, int oblkstr, int xs, int ys);
void BTIC1H_ConvImageAlphaS2TC_I(BTIC1H_Context *ctx, byte *iblock, int iblkstr, byte *oblock, int oblkstr, int xs, int ys);
void BTIC1H_ConvImageS2TCn(BTIC1H_Context *ctx, byte *iblock, int iblkstr, byte *oblock, int bcn, int xs, int ys);
...
void BTIC4B_DecBlockBGR(BTIC4B_Context *ctx,byte *blkbuf, byte *ibuf, int ystr);
...
void BTIC4B_SplitIbufBGR(byte *ibuf, int ystr,int *ybuf, int *ubuf, int *vbuf, int *mcyuv, int *ncyuv);
...
void BTIC4B_EncBlockBGR(BTIC4B_Context *ctx,byte *blkbuf, byte *ibuf, int ystr);
void BTIC4B_EncBlockRGB(BTIC4B_Context *ctx,byte *blkbuf, byte *ibuf, int ystr);
...
void BTIC4B_EncodeCopyBlocks(BTIC4B_Context *ctx,byte *dblks, byte *sblks, int cnt);
int BTIC4B_CheckSkip(BTIC4B_Context *ctx,byte *blk, byte *lblk, int blksz, int qf, int dyem, int dyen, int duvem, int duven, int *rerr);
...
void BTIC4B_S3TC_EncodeBlockI(byte *block,s16 *pxy, int *min, int *max, int mcy, int ncy);
void BTIC4B_S2TC_EncodeBlockAlphaI(byte *block,s16 *pxy, int mcy, int ncy);
void BTIC4B_S3TC_EncodeBlockAlphaI(byte *block,s16 *pxa, int mca, int nca);
...
void BTIC4B_BC4_EncodeBlock(byte *block,s16 *pxy, s16 *pxa, int *min, int *max, int mcy, int ncy, int mca, int nca);
void BTIC4B_BC5_EncodeBlock(byte *block,s16 *pxy, s16 *pxa, int *min, int *max, int mcy, int ncy, int mca, int nca);
void BTIC4B_BC5_EncodeBlockBGRA(byte *block,byte *rgba, int ystr);
...
void BTIC4B_BC4_EncodeBlockBits32(byte *block,u32 pxy, u32 pxa, int *min, int *max);
void BTIC4B_BC5_EncodeBlockBits32(byte *block,u32 pxy, u32 pxa, int *min, int *max);
...
void BTIC4B_BC4_EncodeBlockBits48(byte *block,u64 pxy, u64 pxa, int *min, int *max);
void BTIC4B_BC5_EncodeBlockBits48(byte *block,u64 pxy, u64 pxa, int *min, int *max);
...
void BTIC4B_BC4_EncodeBlockBits64(byte *block,u64 pxy, int *min, int *max);
void BTIC4B_BC5_EncodeBlockBits64(byte *block,u64 pxy, int *min, int *max);
...
void BTIC4B_ConvImageBC3n(BTIC4B_Context *ctx,byte *iblock, int iblkstr, byte *oblock, int xs, int ys);
void BTIC4B_ConvImageBC3nMip(BTIC4B_Context *ctx,byte *iblock, int iblkstr, byte *oblock, int xs, int ys);
void BTIC4B_ConvImageBC4n(BTIC4B_Context *ctx,byte *iblock, int iblkstr, byte *oblock, int xs, int ys);
void BTIC4B_ConvImageBC4nMip(BTIC4B_Context *ctx,byte *iblock, int iblkstr, byte *oblock, int xs, int ys);
void BTIC4B_ConvImageBC5n(BTIC4B_Context *ctx,byte *iblock, int iblkstr, byte *oblock, int xs, int ys);
void BTIC4B_ConvImageBC5nMip(BTIC4B_Context *ctx,byte *iblock, int iblkstr, byte *oblock, int xs, int ys);
...
bgbdt_fbpixel bgbdt_swr_pix2modulate(bgbdt_swpixel pix, u32 cmod);
bgbdt_fbpixel bgbdt_swr_fbpix2ablend(bgbdt_fbpixel spix, bgbdt_fbpixel dpix);
...
BTEIFGL_API void BGBDT_SWR_GetContextImage(BGBDT_SwContext *ctx,u32 *obuf, int xs, int ys);
...
BTEIFGL_API void BGBDT_SWR_DrawTriangleI(BGBDT_SwContext *ctx, BGBDT_SwTriangle *tri);
BTEIFGL_API void BGBDT_SWR_DrawTriangleList(BGBDT_SwContext *ctx, BGBDT_SwTriangle *trilst);
BTEIFGL_API BGBDT_SwTriangle *BGBDT_SWR_AllocTriangle(BGBDT_SwContext *ctx);
BTEIFGL_API void BGBDT_SWR_FreeTriangle(BGBDT_SwContext *ctx, BGBDT_SwTriangle *sp);
BTEIFGL_API void BGBDT_SWR_FreeTriangleList(BGBDT_SwContext *ctx, BGBDT_SwTriangle *sp);
BTEIFGL_API BGBDT_SwTexture *BGBDT_SWR_LookupTexture(BGBDT_SwContext *ctx, int id);
BTEIFGL_API BGBDT_SwTexture *BGBDT_SWR_GetTexture(BGBDT_SwContext *ctx, int id);
BTEIFGL_API void BGBDT_SWR_UpdateTextureImage(BGBDT_SwContext *ctx, BGBDT_SwTexture *tex, u32 *pixbuf, int mip, int xs, int ys, int clrs);
BTEIFGL_API void BGBDT_SWR_BindTexture(BGBDT_SwContext *ctx, int id);
BTEIFGL_API int BGBDT_SWR_AllocTextureId(BGBDT_SwContext *ctx);
BTEIFGL_API void BGBDT_SWR_ProjectVertex(BGBDT_SwContext *ctx, float *ivec, float *ovec);
...
BTEIFGL_API void BGBDT_SWR_EmitDrawTriangle(BGBDT_SwContext *ctx, float *xyz0, float *st0, byte *rgb0, float *xyz1, float *st1, byte *rgb1, float *xyz2, float *st2, byte *rgb2);
BTEIFGL_API void BGBDT_SWR_EmitDrawTriArrayFixS16HF(BGBDT_SwContext *ctx, int base, int num, s16 *xyza, u16 *sta, byte *rgba);
BTEIFGL_API void BGBDT_SWR_EmitDrawTriArrayFixF32(BGBDT_SwContext *ctx, int base, int num, float *xyza, float *sta, void *rgba, int rgbty);
BTEIFGL_API void BGBDT_SWR_EmitDrawQuadArrayFixF32(BGBDT_SwContext *ctx, int base, int num, float *xyza, float *sta, void *rgba, int rgbty);
//AHSRC:swrender/swr_glue.c
