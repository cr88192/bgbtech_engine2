...
BTEIFGL_API int BGBDT_Sound_MixChannel(BGBDT_SndListen *listen, BGBDT_SndMixChan *chan, double dt);
...
BTEIFGL_API int BGBDTC_FinishLayoutClass(BGBDTC_ClassInfo *cls);
BTEIFGL_API int BGBDTC_BeginLayoutClass(BGBDTC_ClassInfo *cls);
BTEIFGL_API int BGBDTC_EndLayoutClass(BGBDTC_ClassInfo *cls);
BTEIFGL_API BGBDTC_SlotInfo *BGBDTC_FetchClassSlotIndex(BGBDTC_ClassInfo *cls, int idx);
int BGBDTC_CheckExpandClassSlotIndex(BGBDTC_ClassInfo *cls, int idx);
BTEIFGL_API BGBDTC_SlotInfo *BGBDTC_GetClassSlotIndex(BGBDTC_ClassInfo *cls, int idx);
BTEIFGL_API BGBDTC_SlotInfo *BGBDTC_LookupClassSlotName(BGBDTC_ClassInfo *cls, char *name);
BTEIFGL_API BGBDTC_SlotInfo *BGBDTC_GetClassSlotName(BGBDTC_ClassInfo *cls, char *name);
BTEIFGL_API BGBDTC_SlotInfo *BGBDTC_LookupClassSlotNameSig(BGBDTC_ClassInfo *cls, char *name, char *sig);
BTEIFGL_API BGBDTC_SlotInfo *BGBDTC_LookupClassMatchSlot(BGBDTC_ClassInfo *cls, BGBDTC_SlotInfo *svi);
BTEIFGL_API dtcObject BGBDTC_AllocClassInstance(BGBDTC_ClassInfo *cls);
int BGBDTC_CheckExpandClassIfaceIndex(BGBDTC_ClassInfo *cls, int idx);
BTEIFGL_API int BGBDTC_CheckClassExtends(BGBDTC_ClassInfo *clsa, BGBDTC_ClassInfo *clsb);
BTEIFGL_API int BGBDTC_CheckClassImplements(BGBDTC_ClassInfo *clsa, BGBDTC_ClassInfo *clsb);
BTEIFGL_API int BGBDTC_CheckObjInstanceof(dtcObject obj, BGBDTC_ClassInfo *cls);
BTEIFGL_API int BGBDTC_CheckObjvObjectP(dtVal obj);
BTEIFGL_API int BGBDTC_CheckObjvInstanceof(dtVal obj, BGBDTC_ClassInfo *cls);
BTEIFGL_API s32 BGBDTC_GetCacheNameI(dtcObject obj,dtcField *rfi, char *qn, char *fn);
BTEIFGL_API s64 BGBDTC_GetCacheNameL(dtcObject obj,dtcField *rfi, char *qn, char *fn);
BTEIFGL_API f32 BGBDTC_GetCacheNameF(dtcObject obj,dtcField *rfi, char *qn, char *fn);
BTEIFGL_API f64 BGBDTC_GetCacheNameD(dtcObject obj,dtcField *rfi, char *qn, char *fn);
BTEIFGL_API dtVal BGBDTC_GetCacheNameA(dtcObject obj,dtcField *rfi, char *qn, char *fn);
BTEIFGL_API void *BGBDTC_GetCacheNamePtr(dtcObject obj,dtcField *rfi, char *qn, char *fn);
BTEIFGL_API int BGBDTC_SetCacheNameI(dtcObject obj,dtcField *rfi, char *qn, char *fn, s32 val);
BTEIFGL_API int BGBDTC_SetCacheNameL(dtcObject obj,dtcField *rfi, char *qn, char *fn, s64 val);
BTEIFGL_API int BGBDTC_SetCacheNameF(dtcObject obj,dtcField *rfi, char *qn, char *fn, f32 val);
BTEIFGL_API int BGBDTC_SetCacheNameD(dtcObject obj,dtcField *rfi, char *qn, char *fn, f64 val);
BTEIFGL_API int BGBDTC_SetCacheNameA(dtcObject obj,dtcField *rfi, char *qn, char *fn, dtVal val);
//AHSRC:mm/mm_lobj.c
...
void BGBDT_XI128_AddWX(BGBDTC_X128 aa, BGBDTC_X128 ab, BGBDTC_X128 ba, BGBDTC_X128 bb, BGBDTC_X128 *rca, BGBDTC_X128 *rcb);
void BGBDT_XI128_NegWX(BGBDTC_X128 aa, BGBDTC_X128 ab,BGBDTC_X128 *rca, BGBDTC_X128 *rcb);
void BGBDT_XI128_NotWX(BGBDTC_X128 aa, BGBDTC_X128 ab,BGBDTC_X128 *rca, BGBDTC_X128 *rcb);
void BGBDT_XI128_SubWX(BGBDTC_X128 aa, BGBDTC_X128 ab, BGBDTC_X128 ba, BGBDTC_X128 bb, BGBDTC_X128 *rca, BGBDTC_X128 *rcb);
BGBDTC_X128 BGBDT_XI128_MulX(BGBDTC_X128 a, BGBDTC_X128 b);
int BGBDT_XI128_MulwX(BGBDTC_X128 a, BGBDTC_X128 b,BGBDTC_X128 *rc, BGBDTC_X128 *rd);
...
int BGBDT_XI128_CmpWX(BGBDTC_X128 aa, BGBDTC_X128 ab, BGBDTC_X128 ba, BGBDTC_X128 bb);
BGBDTC_X128 BGBDT_XI128_OrBitX(BGBDTC_X128 a, int pos);
int BGBDT_XI128_DivuXI(BGBDTC_X128 a, BGBDTC_X128 b,BGBDTC_X128 *rq, BGBDTC_X128 *rr);
int BGBDT_XI128_DivW1XI(BGBDTC_X128 al, BGBDTC_X128 ah, BGBDTC_X128 b, BGBDTC_X128 *rq, BGBDTC_X128 *rr);
int BGBDT_XI128_DivXI(BGBDTC_X128 a, BGBDTC_X128 b,BGBDTC_X128 *rq, BGBDTC_X128 *rr);
...
BTEIFGL_API char *BS2C_ErrStringForMsg(BS2CC_CompileContext *ctx, int ix, int cn, int pix);
...
BTEIFGL_API BSVM2_Trace *BSVM2_Interp_SetupMethodCallVM(BSVM2_Context *ctx, BSVM2_ImageGlobal *vi, dtVal self, BSVM2_Value *args);
BTEIFGL_API int BSVM2_Interp_SetupCacheMethodCallVM(BSVM2_Context *ctx, dtVal self, dtcMethod *rfi, BSVM2_Value *args, char *qn, char *fn, char *sig);
BTEIFGL_API int BSVM2_Interp_CallCacheMethodVM(dtVal self,dtcMethod *rfi, BSVM2_Value *args, char *qn, char *fn, char *sig, int lim);
...
BTEIFGL_API BSVM2_ImageGlobal *BS2I_ImageLookupFunc(BSVM2_CodeImage *img, char *qname);
BTEIFGL_API BSVM2_ImageGlobal *BS2I_ImageLookupGlobalVar(BSVM2_CodeImage *img, char *qname);
...
BSVM2_Trace *BSVM2_TrOp_RETI(BSVM2_Frame *frm, BSVM2_TailOpcode *op);
BSVM2_Trace *BSVM2_TrOp_RETL(BSVM2_Frame *frm, BSVM2_TailOpcode *op);
BSVM2_Trace *BSVM2_TrOp_RETF(BSVM2_Frame *frm, BSVM2_TailOpcode *op);
BSVM2_Trace *BSVM2_TrOp_RETD(BSVM2_Frame *frm, BSVM2_TailOpcode *op);
BSVM2_Trace *BSVM2_TrOp_RETA(BSVM2_Frame *frm, BSVM2_TailOpcode *op);
BSVM2_Trace *BSVM2_TrOp_RETV(BSVM2_Frame *frm, BSVM2_TailOpcode *op);
BSVM2_Trace *BSVM2_TrOp_RETIC(BSVM2_Frame *frm, BSVM2_TailOpcode *op);
BSVM2_Trace *BSVM2_TrOp_RETLC(BSVM2_Frame *frm, BSVM2_TailOpcode *op);
BSVM2_Trace *BSVM2_TrOp_RETFC(BSVM2_Frame *frm, BSVM2_TailOpcode *op);
BSVM2_Trace *BSVM2_TrOp_RETDC(BSVM2_Frame *frm, BSVM2_TailOpcode *op);
BSVM2_Trace *BSVM2_TrOp_RETAC(BSVM2_Frame *frm, BSVM2_TailOpcode *op);
BSVM2_Trace *BSVM2_TrOp_RETIL(BSVM2_Frame *frm, BSVM2_TailOpcode *op);
BSVM2_Trace *BSVM2_TrOp_RETLL(BSVM2_Frame *frm, BSVM2_TailOpcode *op);
BSVM2_Trace *BSVM2_TrOp_RETFL(BSVM2_Frame *frm, BSVM2_TailOpcode *op);
BSVM2_Trace *BSVM2_TrOp_RETDL(BSVM2_Frame *frm, BSVM2_TailOpcode *op);
BSVM2_Trace *BSVM2_TrOp_RETAL(BSVM2_Frame *frm, BSVM2_TailOpcode *op);
BSVM2_Trace *BSVM2_TrOp_CALLG(BSVM2_Frame *frm, BSVM2_TailOpcode *op);
BSVM2_Trace *BSVM2_TrOp_CALLV(BSVM2_Frame *frm, BSVM2_TailOpcode *op);
BSVM2_Trace *BSVM2_TrOp_CALLTH(BSVM2_Frame *frm, BSVM2_TailOpcode *op);
