...
int BGBDTC_FinishLayoutClass(BGBDTC_ClassInfo *cls);
int BGBDTC_BeginLayoutClass(BGBDTC_ClassInfo *cls);
int BGBDTC_EndLayoutClass(BGBDTC_ClassInfo *cls);
...
BGBDTC_SlotInfo *BGBDTC_LookupClassSlotNameSig(BGBDTC_ClassInfo *cls, char *name, char *sig);
BGBDTC_SlotInfo *BGBDTC_LookupClassMatchSlot(BGBDTC_ClassInfo *cls, BGBDTC_SlotInfo *svi);
dtcObject BGBDTC_AllocClassInstance(BGBDTC_ClassInfo *cls);
//AHSRC:mm/mm_lobj.c
