...
typedef struct BTLZA_Context_s BTLZA_Context;

struct BTLZA_VtBitIO_s
{
int (*BS_ReadByte)(BTLZA_Context *ctx);
int (*BS_WriteByte)(BTLZA_Context *ctx, int val);
};

struct BTLZA_Context_s
{
BTLZA_Context *next;
...
//Bitstream Functions
int (*BS_ReadByte)(BTLZA_Context *ctx);
int (*BS_DecodeSymbol)(BTLZA_Context *ctx);
int (*BS_DecodeDistanceSymbol)(BTLZA_Context *ctx);
int (*BS_DecodeClSymbol)(BTLZA_Context *ctx);
int (*BS_ReadExtraNBits)(BTLZA_Context *ctx, int n);
int (*BS_ReadNBits)(BTLZA_Context *ctx, int n);
void (*BS_SkipNBits)(BTLZA_Context *ctx, int n);
int (*BS_ReadBit)(BTLZA_Context *ctx);

void (*BS_WriteByte)(BTLZA_Context *ctx, int val);
void (*BS_EncodeSymbol)(BTLZA_Context *ctx, int sym);
void (*BS_EncodeDistanceSymbol)(BTLZA_Context *ctx, int sym);
void (*BS_EncodeClSymbol)(BTLZA_Context *ctx, int sym);
int (*BS_WriteExtraNBits)(BTLZA_Context *ctx, int v, int n);
int (*BS_WriteNBits)(BTLZA_Context *ctx, int v, int n);
int (*BS_WriteBit)(BTLZA_Context *ctx, int v);
