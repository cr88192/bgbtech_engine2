...
// #include <libvecmath_conf.h>

#include <libvecmath_vecnf.h>

// #include <libvecmath_auto.h>
...
#define V2F_MUL(a, b, c)	\
				(c)[0]=(a)[0]*(b)[0];	\
				(c)[1]=(a)[1]*(b)[1];
#define V3F_MUL(a, b, c)	\
				(c)[0]=(a)[0]*(b)[0];	\
				(c)[1]=(a)[1]*(b)[1];	\
				(c)[2]=(a)[2]*(b)[2];
#define V4F_MUL(a, b, c)	\
				(c)[0]=(a)[0]*(b)[0];	\
				(c)[1]=(a)[1]*(b)[1];	\
				(c)[2]=(a)[2]*(b)[2];	\
				(c)[3]=(a)[3]*(b)[3];

#define V2F_DIV(a, b, c)	\
				(c)[0]=(a)[0]/(b)[0];	\
				(c)[1]=(a)[1]/(b)[1];
#define V3F_DIV(a, b, c)	\
				(c)[0]=(a)[0]/(b)[0];	\
				(c)[1]=(a)[1]/(b)[1];	\
				(c)[2]=(a)[2]/(b)[2];
#define V4F_DIV(a, b, c)	\
				(c)[0]=(a)[0]/(b)[0];	\
				(c)[1]=(a)[1]/(b)[1];	\
				(c)[2]=(a)[2]/(b)[2];	\
				(c)[3]=(a)[3]/(b)[3];
