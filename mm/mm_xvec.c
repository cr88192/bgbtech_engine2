...
BTEIFGL_API dtVal BGBDT_XV128_WrapVec3fv(float *fv)
{
	BGBDTC_X128 *xp;
...
BTEIFGL_API dtVal BGBDT_XV128_WrapVec3f(float x, float y, float z)
{
	BGBDTC_X128 *xp;
...
BTEIFGL_API dtVal BGBDT_XV128_WrapVec4fv(float *fv)
{
	BGBDTC_X128 *xp;
...
BTEIFGL_API dtVal BGBDT_XV128_WrapVec4f(float x, float y, float z, float w)
{
	BGBDTC_X128 *xp;
...
BTEIFGL_API dtVal BGBDT_XV128_WrapQuatfv(float *fv)
{
	BGBDTC_X128 *xp;
...
BTEIFGL_API dtVal BGBDT_XV128_WrapQuatf(float x, float y, float z, float w)
{
	BGBDTC_X128 *xp;
...
BTEIFGL_API int BGBDT_XV128_IsVec3fP(dtVal objv)
	{ return(dtvCheckPtrTagP(objv, objty_v3f)); }
BTEIFGL_API int BGBDT_XV128_IsVec4fP(dtVal objv)
	{ return(dtvCheckPtrTagP(objv, objty_v4f)); }
BTEIFGL_API int BGBDT_XV128_IsQuatfP(dtVal objv)
	{ return(dtvCheckPtrTagP(objv, objty_qf)); }

BTEIFGL_API void BGBDT_XV128_GetVec3fv(dtVal vec, float *fv)
{
	BGBDTC_X128 *xp;
...
BTEIFGL_API void BGBDT_XV128_GetVec4fv(dtVal vec, float *fv)
{
	BGBDTC_X128 *xp;
...
BTEIFGL_API void BGBDT_XV128_GetQuatfv(dtVal vec, float *fv)
{
	BGBDTC_X128 *xp;
